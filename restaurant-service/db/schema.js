import { pgSchema, text, boolean, timestamp, time, numeric, integer, jsonb } from 'drizzle-orm/pg-core';

export const restaurant_svc = pgSchema('restaurant_svc');

export const restaurants = restaurant_svc.table('restaurants', {
  restaurantId: text('restaurant_id').primaryKey().notNull(),
  ...
  deliveryFee: numeric('delivery_fee', { precision: 10, scale: 2 }).notNull().default('2.99'),
